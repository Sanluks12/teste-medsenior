...
const schema = Yup.object().shape({
	...
	confirmPassword: Yup.string().when('password', (password: any, field: any) =>
		password
			? field
					.oneOf([Yup.ref('password')], 'O campo Confirmar Senha deve ser igual ao campo Senha!')
					.required()
		...
		<Page>
			<Container>
				...
				<Form schema={schema} onSubmit={handleSubmit}>
					...
					<Input name="confirmPassword" type="password" placeholder="Confirmar Senha" id="confirm" />
